...
CONFIG.size_of_data_to_convert {5} \
 ] $BinToBCD16_0
...
CONFIG.CONST_WIDTH {4} \
  ...
  connect_bd_net -net btnC_1 [get_bd_ports btnC] [get_bd_pins BinToBCD16_0/reset] [get_bd_pins clockdivider_0/btnc] [get_bd_pins ex1_0/btnC]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins BinToBCD16_0/clk] [get_bd_pins clockdivider_0/clk] [get_bd_pins ex1_0/clk]
  connect_bd_net -net clockdivider_0_led [get_bd_pins EightDispControl_0/clk] [get_bd_pins clockdivider_0/led]
  connect_bd_net -net ex1_0_led [get_bd_pins BinToBCD16_0/binary] [get_bd_pins ex1_0/led]
...
preplace inst xlconstant_1 -pg 1 -lvl 2 -y 40 -defaultsOSRD
preplace inst ex1_0 -pg 1 -lvl 1 -y 180 -defaultsOSRD
preplace inst clockdivider_0 -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace inst BinToBCD16_0 -pg 1 -lvl 2 -y 270 -defaultsOSRD
preplace netloc xlconstant_1_dout 1 2 1 410
