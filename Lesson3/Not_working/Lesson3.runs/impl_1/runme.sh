...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson3/Lesson3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex1_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex1_1_wrapper.tcl -notrace
