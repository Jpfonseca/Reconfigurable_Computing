...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson3/Lesson3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex1_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex1_1_wrapper.tcl
