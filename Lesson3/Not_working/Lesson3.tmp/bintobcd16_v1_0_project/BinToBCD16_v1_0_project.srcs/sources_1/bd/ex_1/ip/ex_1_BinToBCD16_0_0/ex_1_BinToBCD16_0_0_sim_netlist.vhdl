...
--               c:/users/joao/desktop/cr/git/reconfigurable_computing/lesson3/lesson3.tmp/bintobcd16_v1_0_project/BinToBCD16_v1_0_project.srcs/sources_1/bd/ex_1/ip/ex_1_BinToBCD16_0_0/ex_1_BinToBCD16_0_0_sim_netlist.vhdl
...
entity ex_1_BinToBCD16_0_0_BinToBCD16 is
  port (
  ...
  attribute ORIG_REF_NAME of ex_1_BinToBCD16_0_0_BinToBCD16 : entity is "BinToBCD16";
end ex_1_BinToBCD16_0_0_BinToBCD16;

architecture STRUCTURE of ex_1_BinToBCD16_0_0_BinToBCD16 is
  ...
  signal \int_rg_c[0]_i_1_n_0\ : STD_LOGIC;
  signal \int_rg_c[4]_i_1_n_0\ : STD_LOGIC;
  ...
  signal int_rg_n : STD_LOGIC_VECTOR ( 4 downto 1 );
  signal n_s : STD_LOGIC_VECTOR ( 0 to 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \BCD0[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \BCD1[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \BCD2[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \BCD3[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \BCD4[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \BCD4[3]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \BCD4[3]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \c_s[0]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \int_rg_c[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of ready_INST_0 : label is "soft_lutpair5";
begin
...
\int_rg_c[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => reset,
      I1 => c_s(1),
      O => \int_rg_c[4]_i_1_n_0\
    );
\int_rg_c[4]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\int_rg_c_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => \int_rg_c[4]_i_1_n_0\,
      D => \int_rg_c[0]_i_1_n_0\,
...
entity ex_1_BinToBCD16_0_0 is
  ...
  attribute NotValidForBitStream of ex_1_BinToBCD16_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ex_1_BinToBCD16_0_0 : entity is "ex_1_BinToBCD16_0_0,BinToBCD16,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of ex_1_BinToBCD16_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of ex_1_BinToBCD16_0_0 : entity is "BinToBCD16,Vivado 2016.4";
end ex_1_BinToBCD16_0_0;

architecture STRUCTURE of ex_1_BinToBCD16_0_0 is
begin
U0: entity work.ex_1_BinToBCD16_0_0_BinToBCD16
     port map (
      ...
      binary(4 downto 0) => binary(4 downto 0),
      clk => clk,
      ready => ready,
      request => request,
      reset => reset
