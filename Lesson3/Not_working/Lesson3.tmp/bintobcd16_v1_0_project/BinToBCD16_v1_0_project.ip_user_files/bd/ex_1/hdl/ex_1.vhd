...
--Command     : generate_target ex_1.bd
--Design      : ex_1
...
entity ex_1 is
  ...
  attribute CORE_GENERATION_INFO of ex_1 : entity is "ex_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ex_1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of ex_1 : entity is "ex_1.hwdef";
end ex_1;

architecture STRUCTURE of ex_1 is
  component ex_1_ex1_0_0 is
  port (
    clk : in STD_LOGIC;
    btnC : in STD_LOGIC;
    sw : in STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  end component ex_1_ex1_0_0;
  component ex_1_BinToBCD16_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    ready : out STD_LOGIC;
  ...
  end component ex_1_BinToBCD16_0_0;
  component ex_1_EightDispControl_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component ex_1_EightDispControl_0_0;
  component ex_1_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component ex_1_xlconstant_0_0;
  component ex_1_xlconstant_1_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component ex_1_xlconstant_1_0;
...
BinToBCD16_0: component ex_1_BinToBCD16_0_0
     port map (
...
EightDispControl_0: component ex_1_EightDispControl_0_0
     port map (
      clk => clk_1,
...
xlconstant_0: component ex_1_xlconstant_0_0
     port map (
      dout(3 downto 0) => xlconstant_0_dout(3 downto 0)
    );
xlconstant_1: component ex_1_xlconstant_1_0
     port map (
