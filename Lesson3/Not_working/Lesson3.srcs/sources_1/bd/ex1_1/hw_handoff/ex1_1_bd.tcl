...
################################################################
# This is a generated script based on design: ex1_1
#
...
CONFIG.CONST_WIDTH {4} \
  ...
  connect_bd_net -net btnC_1 [get_bd_ports btnC] [get_bd_pins BinToBCD16_0/reset] [get_bd_pins ex1_0/btnC]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins BinToBCD16_0/clk] [get_bd_pins EightDispControl_0/clk] [get_bd_pins ex1_0/clk]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins ex1_0/sw]
...
preplace inst EightDispControl_0 -pg 1 -lvl 3 -y -260 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -y -150 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 2 -y -400 -defaultsOSRD
preplace inst ex1_0 -pg 1 -lvl 1 -y -250 -defaultsOSRD
preplace inst BinToBCD16_0 -pg 1 -lvl 2 -y -230 -defaultsOSRD
preplace netloc xlconstant_1_dout 1 2 1 70
preplace netloc EightDispControl_0_segments 1 3 1 N
preplace netloc BinToBCD16_0_BCD0 1 2 1 N
preplace netloc BinToBCD16_0_BCD1 1 2 1 N
preplace netloc btnC_1 1 0 2 -330 -320 -160
...
preplace netloc xlconstant_0_dout 1 1 1 -150
preplace netloc clk_1 1 0 3 -340 -340 -150 -340 N
preplace netloc sw_1 1 0 1 N
preplace netloc EightDispControl_0_select_display 1 3 1 N
levelinfo -pg 1 -360 -240 -30 260 420 -top -470 -bot 130
",
}
