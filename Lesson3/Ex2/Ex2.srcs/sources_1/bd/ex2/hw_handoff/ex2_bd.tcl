...
CONFIG.CONST_WIDTH {4} \
  ...
  connect_bd_net -net btnC_1 [get_bd_ports btnC] [get_bd_pins BinToBCD16_0/reset] [get_bd_pins clockdivider_0/btnc] [get_bd_pins maxdivider_0/btnC]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins BinToBCD16_0/clk] [get_bd_pins clockdivider_0/clk] [get_bd_pins maxdivider_0/clk]
...
preplace portBus sw -pg 1 -y 230 -defaultsOSRD
preplace portBus an -pg 1 -y 230 -defaultsOSRD
preplace portBus seg -pg 1 -y 250 -defaultsOSRD
preplace inst EightDispControl_0 -pg 1 -lvl 3 -y 240 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 2 -y 30 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 1 -y 310 -defaultsOSRD
preplace inst maxdivider_0 -pg 1 -lvl 1 -y 210 -defaultsOSRD
preplace inst clockdivider_0 -pg 1 -lvl 2 -y 120 -defaultsOSRD
preplace inst BinToBCD16_0 -pg 1 -lvl 2 -y 270 -defaultsOSRD
preplace netloc xlconstant_1_dout 1 1 1 360
...
preplace netloc clockdivider_0_led 1 2 1 570
preplace netloc BinToBCD16_0_BCD2 1 2 1 N
preplace netloc btnC_1 1 0 2 20 140 370J
...
preplace netloc clk_1 1 0 2 30 110 360
preplace netloc sw_1 1 0 1 NJ
preplace netloc EightDispControl_0_select_display 1 3 1 NJ
preplace netloc maxdivider_0_led 1 1 1 350
levelinfo -pg 1 0 270 470 710 860 -top -80 -bot 370
",
}
