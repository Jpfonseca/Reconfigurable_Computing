...
HD_PWD='c:/users/joao/desktop/cr/git/reconfigurable_computing/lesson3/lesson3.tmp/bintobcd16_v1_0_project/BinToBCD16_v1_0_project.runs/ex_1_ex1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex_1_ex1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex_1_ex1_0_0.tcl
