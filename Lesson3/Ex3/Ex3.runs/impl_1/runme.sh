...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson3/Ex3/Ex3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Find1000_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Find1000_wrapper.tcl -notrace
