...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson3/Ex3/Ex3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Find1000_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Find1000_wrapper.tcl
