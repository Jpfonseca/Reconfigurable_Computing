...
architecture STRUCTURE of Find1000 is
  ...
  component Find1000_RandomGenerator_0_2 is
  port (
    clk : in STD_LOGIC;
    random_number : out STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  end component Find1000_RandomGenerator_0_2;
...
RandomGenerator_0: component Find1000_RandomGenerator_0_2
     port map (
      clk => clockdivider_0_led,
