...
entity Find1000 is
  ...
  attribute CORE_GENERATION_INFO of Find1000 : entity is "Find1000,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Find1000,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of Find1000 : entity is "Find1000.hwdef";
end Find1000;

architecture STRUCTURE of Find1000 is
  component Find1000_clockdivider_0_0 is
  port (
    clk : in STD_LOGIC;
    btnc : in STD_LOGIC;
    led : out STD_LOGIC
  );
  end component Find1000_clockdivider_0_0;
  ...
  component Find1000_RandomGenerator_0_0 is
  port (
    clk : in STD_LOGIC;
    random_number : out STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  end component Find1000_RandomGenerator_0_0;
  ...
  signal RandomGenerator_0_random_number : STD_LOGIC_VECTOR ( 15 downto 0 );
...
Find1_0: component Find1000_Find1_0_0
     port map (
      btnC => btnC_1,
      clk => clk_1,
      inp_ut(15 downto 0) => RandomGenerator_0_random_number(15 downto 0),
      led(10 downto 0) => Find1_0_led(10 downto 0)
    );
RandomGenerator_0: component Find1000_RandomGenerator_0_0
     port map (
      clk => clockdivider_0_led,
      random_number(15 downto 0) => RandomGenerator_0_random_number(15 downto 0)
    );
clockdivider_0: component Find1000_clockdivider_0_0
     port map (
      btnc => btnC_1,
      clk => clk_1,
