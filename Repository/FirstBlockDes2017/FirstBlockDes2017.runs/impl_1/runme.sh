...
HD_PWD='K:/CRExamples2017/AT5/Repository/FirstBlockDes2017/FirstBlockDes2017.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FirstBlock_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FirstBlock_wrapper.tcl -notrace
