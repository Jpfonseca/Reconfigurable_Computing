...
HD_PWD='K:/CRExamples2017/AT5/Repository/FirstBlockDes2017/FirstBlockDes2017.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirstBlock_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirstBlock_wrapper.tcl
