...
--Command     : generate_target FirstBlock.bd
--Design      : FirstBlock
...
entity FirstBlock is
  ...
  attribute CORE_GENERATION_INFO of FirstBlock : entity is "FirstBlock,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=FirstBlock,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=4,numReposBlks=4,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of FirstBlock : entity is "FirstBlock.hwdef";
end FirstBlock;

architecture STRUCTURE of FirstBlock is
  component FirstBlock_EightDispControl_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component FirstBlock_EightDispControl_0_0;
  component FirstBlock_BinToBCD16_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    ready : out STD_LOGIC;
  ...
  end component FirstBlock_BinToBCD16_0_0;
  component FirstBlock_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component FirstBlock_xlconstant_0_0;
  component FirstBlock_xlconstant_1_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component FirstBlock_xlconstant_1_0;
...
BinToBCD16_0: component FirstBlock_BinToBCD16_0_0
     port map (
...
EightDispControl_0: component FirstBlock_EightDispControl_0_0
     port map (
      clk => clk_1,
...
xlconstant_0: component FirstBlock_xlconstant_0_0
     port map (
      dout(3 downto 0) => xlconstant_0_dout(3 downto 0)
    );
xlconstant_1: component FirstBlock_xlconstant_1_0
     port map (
