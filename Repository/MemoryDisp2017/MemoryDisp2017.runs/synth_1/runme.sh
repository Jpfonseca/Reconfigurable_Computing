...
HD_PWD='K:/CRExamples2017/AT5/Repository/MemoryDisp2017/MemoryDisp2017.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memdis_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memdis_wrapper.tcl
