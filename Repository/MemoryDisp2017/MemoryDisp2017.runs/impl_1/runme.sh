...
HD_PWD='K:/CRExamples2017/AT5/Repository/MemoryDisp2017/MemoryDisp2017.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memdis_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memdis_wrapper.tcl -notrace
