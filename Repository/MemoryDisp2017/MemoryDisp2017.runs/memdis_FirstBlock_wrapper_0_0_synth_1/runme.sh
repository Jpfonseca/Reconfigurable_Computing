...
HD_PWD='K:/CRExamples2017/AT5/Repository/MemoryDisp2017/MemoryDisp2017.runs/memdis_FirstBlock_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memdis_FirstBlock_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memdis_FirstBlock_wrapper_0_0.tcl
