...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson1/project1/project1.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log ex11.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex11.tcl -notrace
