...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson1/project1/project1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex11.tcl
