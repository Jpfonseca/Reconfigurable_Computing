...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson2/Lesson2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex1_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex1_tb.tcl
