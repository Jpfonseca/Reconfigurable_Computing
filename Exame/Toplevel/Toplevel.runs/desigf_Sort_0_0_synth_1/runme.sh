...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Exame/Toplevel/Toplevel.runs/desigf_Sort_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log desigf_Sort_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source desigf_Sort_0_0.tcl
