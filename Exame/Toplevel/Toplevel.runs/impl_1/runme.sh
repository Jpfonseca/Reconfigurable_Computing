...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Exame/Toplevel/Toplevel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log desigf_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source desigf_wrapper.tcl -notrace
