...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Exame/Toplevel/Toplevel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log desigf_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source desigf_wrapper.tcl
