...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Exame/Toplevel/Toplevel.runs/desigf_EightDispControl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log desigf_EightDispControl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source desigf_EightDispControl_0_0.tcl
