...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Convert_10_8_to_8_10_FSM is
  ...
  attribute SOFT_HLUTNM of \converted_words_reg[0][3]_i_2\ : label is "soft_lutpair1";
  attribute XILINX_LEGACY_PRIM of \converted_words_reg[0][4]\ : label is "LD";
  attribute SOFT_HLUTNM of \converted_words_reg[0][4]_i_2\ : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of \converted_words_reg[0][5]\ : label is "LD";
  attribute SOFT_HLUTNM of \converted_words_reg[0][5]_i_2\ : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM of \converted_words_reg[0][6]\ : label is "LD";
  attribute SOFT_HLUTNM of \converted_words_reg[0][6]_i_2\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \converted_words_reg[0][7]_i_3\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \converted_words_reg[0][9]_i_6\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \converted_words_reg[1][9]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \converted_words_reg[6][9]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \current_address[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \current_address[1]_i_1\ : label is "soft_lutpair2";
...
\converted_words_reg[0][9]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\converted_words_reg[0][9]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
\converted_words_reg[0][9]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
