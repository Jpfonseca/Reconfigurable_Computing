...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Projecto_final/FSM/FSM/FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inverter_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inverter_Test.tcl
