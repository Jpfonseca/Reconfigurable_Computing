...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Projecto_final/bit32disp/bit32disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_32_disp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_32_disp_wrapper.tcl
