...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Projecto_final/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hamming_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hamming_tb.tcl
