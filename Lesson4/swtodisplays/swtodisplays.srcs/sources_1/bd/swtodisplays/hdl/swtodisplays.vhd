...
--Command     : generate_target swtodisplays.bd
--Design      : swtodisplays
...
entity swtodisplays is
  ...
  attribute CORE_GENERATION_INFO of swtodisplays : entity is "swtodisplays,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=swtodisplays,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of swtodisplays : entity is "swtodisplays.hwdef";
end swtodisplays;

architecture STRUCTURE of swtodisplays is
  component swtodisplays_EightDispControl_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component swtodisplays_EightDispControl_0_0;
  component swtodisplays_clockdivider_0_0 is
  port (
    clk : in STD_LOGIC;
    btnc : in STD_LOGIC;
    led : out STD_LOGIC
  );
  end component swtodisplays_clockdivider_0_0;
  component swtodisplays_BinToBCD16_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    ready : out STD_LOGIC;
  ...
  end component swtodisplays_BinToBCD16_0_0;
  component swtodisplays_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component swtodisplays_xlconstant_0_0;
  component swtodisplays_xlconstant_1_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component swtodisplays_xlconstant_1_0;
...
BinToBCD16_0: component swtodisplays_BinToBCD16_0_0
     port map (
...
EightDispControl_0: component swtodisplays_EightDispControl_0_0
     port map (
...
clockdivider_0: component swtodisplays_clockdivider_0_0
     port map (
      btnc => btnC_1,
      clk => clk_1,
      led => clockdivider_0_led
    );
xlconstant_0: component swtodisplays_xlconstant_0_0
     port map (
      dout(0) => xlconstant_0_dout(0)
    );
xlconstant_1: component swtodisplays_xlconstant_1_0
     port map (
