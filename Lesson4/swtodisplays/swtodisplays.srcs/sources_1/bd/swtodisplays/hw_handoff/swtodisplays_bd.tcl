...
################################################################
# This is a generated script based on design: swtodisplays
#
...
# source swtodisplays_script.tcl
...
CONFIG.CONST_WIDTH {4} \
  ...
  connect_bd_net -net btnC_1 [get_bd_ports btnC] [get_bd_pins BinToBCD16_0/reset] [get_bd_pins clockdivider_0/btnc]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins BinToBCD16_0/clk] [get_bd_pins clockdivider_0/clk]
...
preplace portBus sw -pg 1 -y 350 -defaultsOSRD
...
preplace netloc xlconstant_1_dout 1 2 1 370
...
preplace netloc btnC_1 1 0 2 NJ 140 140
preplace netloc clockdivider_0_led 1 2 1 360
...
preplace netloc clk_1 1 0 2 NJ 120 150
preplace netloc sw_1 1 0 2 NJ 350 150J
preplace netloc EightDispControl_0_select_display 1 3 1 NJ
levelinfo -pg 1 0 80 260 500 650 -top 0 -bot 370
",
}
