...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson4/swtodisplays/swtodisplays.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log swtodisplays_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source swtodisplays_wrapper.tcl -notrace
