...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson4/swtodisplays/swtodisplays.runs/swtodisplays_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swtodisplays_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swtodisplays_xlconstant_0_0.tcl
