...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson4/32bitstodisp/32bitstodisp.runs/disp32bits_xlslice_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log disp32bits_xlslice_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source disp32bits_xlslice_0_0.tcl
