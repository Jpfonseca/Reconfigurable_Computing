...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson4/32bitstodisp/32bitstodisp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log disp32bits_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source disp32bits_wrapper.tcl -notrace
