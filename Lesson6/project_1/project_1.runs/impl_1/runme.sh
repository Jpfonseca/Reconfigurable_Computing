...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson6/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log desinf_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source desinf_wrapper.tcl -notrace
