...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson6/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log desinf_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source desinf_wrapper.tcl
