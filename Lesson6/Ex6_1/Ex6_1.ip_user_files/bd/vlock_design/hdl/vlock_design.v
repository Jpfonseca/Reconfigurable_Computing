...
module vlock_design
  ...
  wire ClockDivider_1_divided_clock;
  ...
  vlock_design_ClockDivider_0_1 ClockDivider_0
       (.clk(clk_1),
        ...
        .reset(btnC_1));
  vlock_design_ClockDivider_1_0 ClockDivider_1
       (.clk(ClockDivider_0_divided_clock),
        .divided_clock(ClockDivider_1_divided_clock),
        .reset(btnC_1));
