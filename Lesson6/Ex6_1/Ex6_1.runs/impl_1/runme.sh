...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson6/Ex6_1/Ex6_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vlock_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vlock_design_wrapper.tcl -notrace
