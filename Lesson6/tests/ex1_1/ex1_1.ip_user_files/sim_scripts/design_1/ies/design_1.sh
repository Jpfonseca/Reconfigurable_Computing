...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../ex1_1.srcs/sources_1/bd/design_1/ipshared/100a" \
       +incdir+"$ref_dir/../../../../ex1_1.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"../../../../ex1_1.srcs/sources_1/bd/design_1/ipshared/100a" \
       +incdir+"../../../../ex1_1.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl"
}
