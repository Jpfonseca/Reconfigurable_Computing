...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson6/ex1/ex1.runs/desig1_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log desig1_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source desig1_lmb_bram_0.tcl
