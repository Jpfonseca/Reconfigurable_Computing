...
HD_PWD='C:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson6/ex1/ex1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log desig1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source desig1_wrapper.tcl -notrace
