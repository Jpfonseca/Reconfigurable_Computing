...
--               c:/Users/Joao/Desktop/cr/Git/Reconfigurable_Computing/Lesson6/project_1/project_1.srcs/sources_1/bd/desinf/ip/desinf_counter_0_0/desinf_counter_0_0_sim_netlist.vhdl
-- Design      : desinf_counter_0_0
...
entity desinf_counter_0_0_counter is
  port (
  ...
  attribute ORIG_REF_NAME of desinf_counter_0_0_counter : entity is "counter";
end desinf_counter_0_0_counter;

architecture STRUCTURE of desinf_counter_0_0_counter is
  ...
  signal \^val_output\ : STD_LOGIC_VECTOR ( 15 downto 0 );
...
begin
  val_output(15 downto 0) <= \^val_output\(15 downto 0);
...
\increment[12]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
        ...
        port map (
      I0 => \increment_reg_n_0_[14]\,
      O => \increment[12]_i_3_n_0\
    );
\increment[12]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \increment_reg_n_0_[13]\,
      O => \increment[12]_i_4_n_0\
    );
\increment[12]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
entity desinf_counter_0_0 is
  ...
  attribute NotValidForBitStream of desinf_counter_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of desinf_counter_0_0 : entity is "desinf_counter_0_0,counter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of desinf_counter_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of desinf_counter_0_0 : entity is "counter,Vivado 2016.4";
end desinf_counter_0_0;

architecture STRUCTURE of desinf_counter_0_0 is
begin
U0: entity work.desinf_counter_0_0_counter
     port map (
      clock => clock,
